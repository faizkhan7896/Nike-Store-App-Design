...
import Walkingproduct from './Walkingproduct'
    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Walking Shoes (89)</Text>
                ...
                <Walkingproduct navigation={navigation} />
