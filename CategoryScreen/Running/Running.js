...
import Runningproduct from './Runningproduct'
    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}> Running Shoes (89)</Text>
                ...
                <Runningproduct navigation={navigation} />
