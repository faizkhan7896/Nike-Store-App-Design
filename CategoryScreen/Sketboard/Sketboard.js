...
import Sketboardproduct from './Sketboardproduct'




const Sketboard = ({ navigation }) => {
    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Sketboard Shoes (193)</Text>
                ...
                <Sketboardproduct navigation={navigation} />
