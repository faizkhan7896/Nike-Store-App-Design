...
import Baseballproduct from './Baseballproduct'
    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Baseball Shoes (89)</Text>
                ...
                <Baseballproduct navigation={navigation} />
