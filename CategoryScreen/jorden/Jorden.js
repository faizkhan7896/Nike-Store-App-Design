...
import Jordenproduct from './Jordenproduct'




const Jorden = ({ navigation }) => {
    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Jorden Shoes (209)</Text>
                ...
                <Jordenproduct navigation={navigation} />
