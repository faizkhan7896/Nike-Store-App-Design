...
import Athleticsproduct from './Athleticsproduct'
    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Men's Atheletics Shoes (189)</Text>
                ...
                <Athleticsproduct navigation={navigation} />
...
//                 </View>
//                 <View style={{ flexDirection: "row", marginTop: 20, }}>
//                     <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Athletics Shoes (89)</Text>
//                     <Image source={require("../../Assets/filter2.png")}
//                         style={{ height: 35, width: 40, marginLeft: 130 }} />
...
// export default Athleticsproduct;
