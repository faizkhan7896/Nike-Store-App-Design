    ...
    return (
        ...
        >
            ...
            <ScrollView>
                ...
                <Text style={{ fontSize: 23, fontWeight: "bold", color: "#4f4f4f", marginLeft: 40, marginTop: 80 }}>NIKE PRIVACY POLICY</Text>


                <Text style={{ fontSize: 18, fontWeight: "bold", color: "gray", marginLeft: 40, marginTop: 15, marginRight: 40 }}>Effective Date: October 12, 2020</Text>
                <Text style={{ fontSize: 15, fontWeight: "bold", color: "gray", marginTop: 20, marginLeft: 40, marginRight: 40 }}>This privacy policy describes the personal data collected or processed when you interact with Nike, including through our websites, digital experiences, mobile apps, stores, online or offline events, or one of our other products or services, all of which are part of Nike’s Platform (“Platform”).  It also explains how your personal data is used, shared and protected, what choices you have relating to your personal data, and how you can contact us.</Text>

                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>the product is not available / in stock;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>your billing information is not correct or not verifiable;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>your order is flagged up by our security systems as an unusual order or an order susceptible to fraud;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>your bank transfer payment is not received within 12 calendar days after acceptance of your order;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>we believe you are under the legal age in your country;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>we believe that you are a reseller;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>there was an error in the price displayed on the Platform;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>we could not deliver to the address provided by you;</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>due to an Event Outside Our Control (see below); or</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, }}>
                    <Text style={{ fontSize: 50, marginTop: -35, marginLeft: 40, }}>.</Text>
                    <Text style={{ fontSize: 17, marginTop: 8, fontWeight: "bold", color: "#666", marginLeft: 10, marginRight: 80 }}>in the event of misspelling, pricing or other errors or mistakes in the Platform information.</Text>
                </View>
