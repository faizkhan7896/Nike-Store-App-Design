    ...
    return (
        ...
        >
            ...
            <ScrollView>
                ...
                <Text style={{ fontSize: 30, fontWeight: "bold", color: "#666", alignSelf: "center", marginTop: 80 }}>NIKE TERMS OF USE</Text>


                <Text style={{ fontSize: 15, fontWeight: "bold", color: "#666", marginLeft: 40, marginTop: 15, marginRight: 40 }}>Date of last revision: April 2021</Text>
                <Text style={{ fontSize: 15, fontWeight: "bold", color: "#666", marginTop: 30, marginLeft: 40, marginRight: 40 }}>PLEASE READ THESE TERMS OF USE (“TERMS”) CAREFULLY BEFORE USING ANY NIKE PLATFORM.</Text>
