    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Men's Clothings (389)</Text>
                ...
                <Mensproduct navigation={navigation} />
                <View>
                    <FlatList
                        keyExtractor={(item) => item.id.toString()}
                        horizontal={true}
                        ...
                        renderItem={({ index, item }) =>
                            <TouchableOpacity
                                onPress={() => navigation.navigate(item.link)}
                                style={{
                                    marginTop: 5, height: 30, width: 150, borderWidth: 0.5, borderColor: "gray",
                                    backgroundColor: '#fff', alignItems: "center", justifyContent: "center",
