...
import Womensproduct from '../Women/Womensproduct'




const Arrivalsclothes = ({ navigation }) => {
    ...
    return (
        ...
        >
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginTop: 20, }}>
                    <Text style={{ marginLeft: 40, fontSize: 20, fontWeight: "bold" }}>Arrival sproduct Clothings (389)</Text>
                ...
                <Arrivalsproduct navigation={navigation} />
                <Womensproduct navigation={navigation} />
                <View>
                    <FlatList
                        keyExtractor={(item) => item.id.toString()}
                        horizontal={true}
...
export default Arrivalsclothes;
